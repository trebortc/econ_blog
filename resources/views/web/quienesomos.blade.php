...
@section('contenido')
    <div class="container-fluid">
            ...
            <div class="col-10 offset-1">
                <div class="row pt-3 justify-content-center">
                    <div class="col cont text-center">
                        <img class="img-fluid border image-efect-1 rounded" src="{{ asset('image/quienesomos1.png') }}">
                    </div>
                    <div class="col cont text-center">
                        <img class="img-fluid border image-efect-1 rounded" src="{{ asset('image/quienesomos2.png') }}">
                    </div>
                    <div class="col cont text-center">
                        <img  class="img-fluid border image-efect-1 rounded" src="{{ asset('image/quienesomos3.png') }}">
                    </div>
                </div>
            </div>      
        </div>
        ...
        <div class="row justify-content-center">
                <div class="col-9">
                <div class="media">
                    <img class="align-self-center mr-3 img-fluid rounded image-efect-1" src="{{ asset('image/econ_gerente.png') }}" alt="Generic placeholder image" style="width: 20%;">
        ...
        <div class="row justify-content-center">
            <div class="col-9">
                <div class="media">
                    <figure class="figure">
                        <img src="{{ asset('image/econ_vision.png') }}" class="figure-img img-fluid rounded mr-3 pt-2 image-efect-1" alt="A generic square placeholder image with rounded corners in a figure." style="width: 220px;">
        ...
        <div class="row justify-content-center">
            <div class="col-9">
                <div class="media">
                    ...
                    <img class="ml-3 rounded image-efect-1" src="{{ asset('image/econ_mision.png') }}" alt="Generic placeholder image" style="width: 220px;">
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
        ...
        <div class="row justify-content-center">
            <div class="col-9">
                <div class="media">
                    <img src="{{ asset('image/econ_filosofia.png') }}" class="figure-img img-fluid rounded mr-3 pt-2 image-efect-1" alt="A generic square placeholder image with rounded corners in a figure." style="width: 220px;">
                    <div class="media-body">
